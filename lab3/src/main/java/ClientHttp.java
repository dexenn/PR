...
public class ClientHttp
{
    ...
    public void loginAndPrintFriends() throws IOException, InterruptedException
    {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://" + target.getHostName()+ "/dexenftp/friends"))
            ...
            PrintWriter printWriter = new PrintWriter(new FileWriter("/home/dexen/server/univer/PR/lab3/dfr.txt"));
    ...
    private void printFriends() throws IOException
    {
        ...
        BufferedReader r = new BufferedReader(new FileReader("/home/dexen/server/univer/PR/lab3/dfr.txt"));
        ...
        matches.remove("Dumitru Catarau");
